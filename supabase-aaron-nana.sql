...
Questions à lui poser. 1. Maths expertes ou non : conditionne Cambridge Economics et pèse pour Oxford E&M. 2. Qui a été sollicité au lycée pour la référence UCAS et les notes prédites, et pour les deux lettres américaines. 3. Le compte UCAS est-il ouvert et rattaché à Sainte-Croix. 4. Quelle université en tour anticipé, et sous quelle forme, contraignante ou non. 5. Aide financière demandée ou non : change la liste (NYU, Berkeley ne couvrent pas les internationaux). 6. Pourquoi refaire l’IELTS : 7.0 suffit à la plupart, vérifier les minima par section avant de payer une session en pleine saison. 7. Le TMUA est-il exigé par chacun des six programmes ou seulement Cambridge et LSE. 8. Quelles lectures et quels concours en économie : rien sur le super-curriculaire, décisif au Royaume-Uni. 9. Bulletins de première et rang.
