/**
 * English layer for the milestone reference — the sellable material.
 * Loaded only inside the authenticated client area, never by the public demo.
 */
...
export const MILESTONES_EN = {
  ...
  'C-15': {
    title: 'Guiding the personal statement', when: 'July – August',
  ...
  'C-16': {
    title: 'Guiding the main essay', when: 'July – August',
  ...
  'D-03': { title: 'Final university list', when: 'September',
    ...
    family: 'Tell us what you are removing and why. A university dropped in September cannot be recovered in November: its own essays will not have been written. Budget for application fees: 50 to 90 dollars per American university, a single flat fee for the five British choices.' },
  ...
  'D-12': {
    ...
    carmine: 'Each application read through, every receipt filed, and each university checked for receipt of scores.',
    family: 'Have the official SAT scores sent by College Board, and the IELTS or TOEFL scores by the test centre, university by university: sending is paid for and takes several days. Understand the commitment: a binding early application obliges the student to enrol if admitted.',
  ...
  'D-19': { title: 'Regular round deadlines', when: '1 – 5 January',
    ...
    family: 'Have the official scores sent to every regular-round university that does not accept self-reporting, before submitting.' },
  ...
  'D-22': {
    ...
    carmine: 'Choices built, motivation statements worked line by line with the student, and the whole articulated with the rest of the calendar.',
