...
export const MILESTONES = [
  ...
  },
  {
    ...
    obj: "Faire savoir à l'élève que ses notes de troisième seront lues par les universités américaines — tant qu'il est encore temps de les soigner.",
  ...
  },
  {
    ...
    when: 'Juillet – août',
    obj: "Écrire les six cent cinquante mots de l'essai personnel de la Common App, seul endroit du dossier où l'élève parle en son nom.",
  ...
  },
  {
    ...
    when: 'Début décembre',
    obj: "Franchir l'étape qui décide réellement de l'admission à Oxbridge : le dossier ouvre la porte, l'entretien tranche.",
  ...
  },
  {
    ...
    when: 'Mi-décembre',
    obj: 'Recevoir la première décision — et réarbitrer aussitôt le tour ordinaire, qui se joue dans les deux semaines suivantes.',
  ...
  },
  {
    ...
    obj: "Découvrir le coût net réel de chaque admission. C'est ici, pas avant, que la liste devient un choix.",
  ...
  },
  {
    ...
    title: 'Logement',
    when: 'Mai – juillet',
    obj: 'Obtenir un logement avant que les résidences ne soient pleines — les attributions se font souvent avant même le visa.',
