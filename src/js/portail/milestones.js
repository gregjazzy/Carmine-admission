...
export const MILESTONES = [
  ...
  {
    id: 'A-0B', phase: 0, tracks: ['uk', 'us', 'eu'], kind: 'document', repere: true,
    owners: ['parents'], y: -3, m: 9, d: 12,
    title: 'Bulletins depuis la troisième',
    when: "À l'entrée en accompagnement, avant la note de positionnement",
    obj: "Lire le parcours réel avant de le situer : les universités américaines lisent à partir de la troisième, les britanniques et les prépas jugent la régularité et la progression, pas une seule année.",
    carmine: "La lecture trimestre par trimestre dans la note de positionnement : moyennes, rang, spécialités, progression, et ce que chaque cible en fera.",
    family: "Déposez ici les bulletins de chaque trimestre depuis la troisième, tels que le lycée les fournit, avec le rang de classe s'il y figure. Un fichier par bulletin ou un seul PDF, comme vous voulez.",
    upload: ['Bulletins de troisième, seconde, première : chaque trimestre'],
  },
  {
    ...
    family: "L'élève prépare la page demandée avant l'entretien et l'envoie deux jours avant. Les parents n'ont rien à préparer : l'entretien se tient avec l'élève seul.",
    upload: ["La page préparée par l'élève"],
  ...
  },
  {
    ...
    obj: "Prévenir l'élève dès la rentrée de troisième que ses notes comptent désormais : elles seront lues par les universités américaines.",
  ...
  },
  {
    ...
    obj: "Déposer la candidature pour les autres universités britanniques : cinq vœux au total, qu'aucune d'elles ne voit les uns des autres.",
  ...
  },
  {
    ...
    when: '15 janvier',
    obj: 'Déposer les candidatures néerlandaises à places limitées et suédoises : ces filières ferment des mois avant les autres.',
  ...
  },
  {
    ...
    obj: "Rassembler les décisions et le détail de l'aide accordée : c'est ce qui révèle le coût net réel, et transforme la liste en choix.",
  ...
  },
  {
    ...
    when: '1er mai',
    obj: "Verser l'acompte auprès de l'université retenue : c'est ce geste, et lui seul, qui réserve la place.",
  ...
  },
  {
    ...
    when: '1er mai',
    obj: "Déposer les candidatures néerlandaises hors places limitées, dont l'échéance est plus tardive que la première vague.",
...
/* ─── Mécanique de calendrier ────────────────────────────────────────────────
   La logique pure (dates, classes, urgence) vit dans calendrier.js, sans
...
export const scheduleFor = (tracks, terminaleStartYear) =>
  scheduleForIn(MILESTONES, tracks, terminaleStartYear);
...
export const outOfScope = (tracks, terminaleStartYear, fromClass) =>
  outOfScopeIn(MILESTONES, tracks, terminaleStartYear, fromClass);
